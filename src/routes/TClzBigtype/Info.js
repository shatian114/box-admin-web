  ...
  handleSubmit = e => {
    ...
    this.props.form.validateFieldsAndScroll((err, values) => {
      if (!err) {
        ...
        const { dispatch } = this.props;
        if (this.props.base.info.tClzBigtypeId) {
          dispatch({
            type: 'base/fetch',
            payload: {
              ...values,
    ...
    return (
      <Spin size="large" spinning={loading}>
        <Form onSubmit={this.handleSubmit}>
          <FormItem {...formItemLayout} hasFeedback label="大类id">
          ...
          <FormItem {...formItemLayout} hasFeedback label="大类名称">
              ...
              rules: [
                {
                  required: true,
                  message: '大类名称不能缺失!',
                },{ max: 255,message: '大类名称必须小于255位!',   },
              ],
             })(<Input placeholder="请输入" />)}
          </FormItem>
          <FormItem {...formItemLayout} hasFeedback label="大类描述">

 ...
 * @Last Modified time: 2018-06-11 18:02:37
 * @Description:条码
 */
...
export default class WmsQingxiList extends Component {
  ...
  componentWillReceiveProps(nextProps) {
    countS = 0;
    for (var item of nextProps.list.list) {
      if (item.count) {
  ...
  render() {
    ...
    const listConfig = {
      url: '/api/query/queryWmsRecoverinorderCountList', // 必填,请求url

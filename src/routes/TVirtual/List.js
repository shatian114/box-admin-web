            ...
            <Row gutter={{ md: 8, lg: 24, xl: 48 }}>
              <Col {...formItemGrid}>
                ...
                <FormItem {...formItemLayout} label="">
                  {getFieldDecorator('t_virtual_id', {
                    initialValue: this.props.list.queryMap.t_virtual_id,
                  })(<Input placeholder="请输入" />)}{' '}
                </FormItem>{' '}
              </Col>
              <Col {...formItemGrid}>
                {' '}
                <FormItem {...formItemLayout} label="虚拟物品类别id(起始)">
              ...
              <Col {...formItemGrid}>
                {' '}
                <FormItem {...formItemLayout} label="虚拟物品类别id(结束)">
              ...
              <Col {...formItemGrid}>
                {' '}
                <FormItem {...formItemLayout} label="虚拟物品编号">
              ...
              <Col {...formItemGrid}>
                {' '}
                <FormItem {...formItemLayout} label="虚拟物品名称">
              ...
              <Col {...formItemGrid}>
                {' '}
                <FormItem {...formItemLayout} label="图片索引">
              ...
              <Col {...formItemGrid}>
                {' '}
                <FormItem {...formItemLayout} label="虚拟产品描述">
              ...
              <Col {...formItemGrid}>
                {' '}
                <FormItem {...formItemLayout} label="虚拟产品链接">
                  {getFieldDecorator('virtuallink', {
                    initialValue: this.props.list.queryMap.virtuallink,
                  })(<Input placeholder="请输入" />)}{' '}
                </FormItem>{' '}
              </Col>
              <Col {...formItemGrid}>
                {' '}
                <FormItem {...formItemLayout} label="是否显示增强描述">
                  {getFieldDecorator('isshowextendlink', {
                    initialValue: this.props.list.queryMap.isshowextendlink,
                  })(<Input placeholder="请输入" />)}{' '}
                </FormItem>{' '}
              </Col>
              <Col {...formItemGrid}>
                {' '}
                <FormItem {...formItemLayout} label="增强描述链接">
                  {getFieldDecorator('extendlink', {
                    initialValue: this.props.list.queryMap.extendlink,
                  })(<Input placeholder="请输入" />)}{' '}
                </FormItem>{' '}
              </Col>
              <Col {...formItemGrid}>
                {' '}
                <FormItem {...formItemLayout} label="购买前的提示">
              ...
              <Col {...formItemGrid}>
                {' '}
                <FormItem {...formItemLayout} label="是否免费(起始)">
                  {getFieldDecorator('start_isfree', {
                    initialValue: this.props.list.queryMap.start_isfree
                      ? moment(this.props.list.queryMap.start_isfree)
                      : null,
                  })(<InputNumber placeholder="请输入" />)}{' '}
                </FormItem>{' '}
              </Col>
              <Col {...formItemGrid}>
                {' '}
                <FormItem {...formItemLayout} label="是否免费(结束)">
                  {getFieldDecorator('end_isfree', {
                    initialValue: this.props.list.queryMap.end_isfree
                      ? moment(this.props.list.queryMap.end_isfree)
                      : null,
                  })(<InputNumber placeholder="请输入" />)}{' '}
                </FormItem>{' '}
              </Col>
              ...
              <Col {...formItemGrid}>
                ...
                <FormItem {...formItemLayout} label="">
                  {getFieldDecorator('extendtext', {
                    initialValue: this.props.list.queryMap.extendtext,
                  })(<Input placeholder="请输入" />)}{' '}
                </FormItem>{' '}
              </Col>
              <Col {...formItemGrid}>
                ...
                <FormItem {...formItemLayout} label="">
                  {getFieldDecorator('extendvidepic', {
                    initialValue: this.props.list.queryMap.extendvidepic,
                  })(<Input placeholder="请输入" />)}{' '}
                </FormItem>{' '}
              </Col>
              <Col {...formItemGrid}>
                ...
                <FormItem {...formItemLayout} label="">
                  {getFieldDecorator('extendvideourl', {
                    initialValue: this.props.list.queryMap.extendvideourl,
                  })(<Input placeholder="请输入" />)}{' '}
                </FormItem>{' '}
              </Col>
              <Col {...formItemGrid}>
                ...
                <FormItem {...formItemLayout} label="">
                  {getFieldDecorator('extendrotate', {
                    initialValue: this.props.list.queryMap.extendrotate,
                  })(<Input placeholder="请输入" />)}{' '}
                </FormItem>{' '}
              </Col>
              <Col {...formItemGrid}>
              ...
              <Col {...formItemGrid}>
                {' '}
                <FormItem {...formItemLayout} label="发布者的个人合作者账户">
                  {getFieldDecorator('accountprivate', {
                    initialValue: this.props.list.queryMap.accountprivate,
                  })(<Input placeholder="请输入" />)}{' '}
                </FormItem>{' '}
              </Col>
              <Col {...formItemGrid}>

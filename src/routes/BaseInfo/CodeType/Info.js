 ...
 * @Last Modified time: 2018-05-17 15:52:08
 * @Description: 字典详情
 */
    ...
    return (
      <Spin size="large" spinning={loading}>
        <Form onSubmit={this.handleSubmit}>
          <FormItem {...formItemLayout} hasFeedback label="条码类型编号">
            {getFieldDecorator('dicCode', {
              ...
              rules: [
                ...
                {
                  max: 64,
                  message: '条码类型编号必须小于64位!',
                },
              ],
            })(<Input disabled={info.dicId !== undefined} placeholder="请输入条码类型编号" />)}
          </FormItem>
          <FormItem {...formItemLayout} hasFeedback label="条码类型名称">
            {getFieldDecorator('dicName', {
              ...
              rules: [
                ...
                {
                  max: 64,
                  message: '条码类型名称必须小于64位!',
                },
              ],
            })(<Input placeholder="请输入条码类型名称" />)}
          </FormItem>
          <FormItem {...formItemLayout} hasFeedback label="条码类型缩写(一位且不能重复)">

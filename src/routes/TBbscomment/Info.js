...
{getFieldDecorator('tBbscommentId', {
 initialValue: info.tBbscommentId || newInfo.tBbscommentId,
  rules: [
    {
      required: true,
      message: '不能缺失!',
...
{getFieldDecorator('cardid', {
 ...
 <FormItem {...formItemLayout} hasFeedback label="评论内容">
  ...
  rules: [
    {
      required: true,
      message: '评论内容不能缺失!',
    },{ max: 255,message: '评论内容必须小于255位!',   },
  ],
 })(<Input placeholder="请输入" />)}
 </FormItem>
 <FormItem {...formItemLayout} hasFeedback label="评论者账户">
  ...
  rules: [
    {
      required: true,
      message: '评论者账户不能缺失!',
    },{ max: 40,message: '评论者账户必须小于40位!',   },
  ],
 })(<Input placeholder="请输入" />)}
 </FormItem>
 <FormItem {...formItemLayout} hasFeedback label="评论时间">
...
{getFieldDecorator('deletehava', {
 ...
 <FormItem {...formItemLayout} hasFeedback label="评论ip">

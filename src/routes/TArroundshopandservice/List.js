            ...
            <Row gutter={{ md: 8, lg: 24, xl: 48 }}>
              <Col {...formItemGrid}>
                ...
                <FormItem {...formItemLayout} label="">
                  {getFieldDecorator('t_arroundshopandservice_id', {
                    initialValue: this.props.list.queryMap.t_arroundshopandservice_id,
              ...
              <Col {...formItemGrid}>
                {' '}
                <FormItem {...formItemLayout} label="实体店名称">
                  {getFieldDecorator('shopname', {
                    initialValue: this.props.list.queryMap.shopname,
                  })(<Input placeholder="请输入" />)}{' '}
                </FormItem>{' '}
              </Col>
              <Col {...formItemGrid}>
                {' '}
                <FormItem {...formItemLayout} label="实体店描述">
                  {getFieldDecorator('shopdesc', {
                    initialValue: this.props.list.queryMap.shopdesc,
                  })(<Input placeholder="请输入" />)}{' '}
                </FormItem>{' '}
              </Col>
              <Col {...formItemGrid}>
              ...
              <Col {...formItemGrid}>
                {' '}
                <FormItem {...formItemLayout} label="地图位置">
                  {getFieldDecorator('maplink', { initialValue: this.props.list.queryMap.maplink })(
                    <Input placeholder="请输入" />
                  )}{' '}
                </FormItem>{' '}
              </Col>
              ...
              <Col {...formItemGrid}>
                ...
                <FormItem {...formItemLayout} label="座机">
                  {getFieldDecorator('telephone', {
                    initialValue: this.props.list.queryMap.telephone,
                  })(<Input placeholder="请输入" />)}{' '}
                </FormItem>{' '}
              </Col>
              <Col {...formItemGrid}>
              ...
              <Col {...formItemGrid}>
                {' '}
                <FormItem {...formItemLayout} label="店铺主图">

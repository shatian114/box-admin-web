...
const { Option } = Select;
//const routerUrl = cache.keysMenu.TMsg;
const routerUrl ='/TMsg';
const url = 'TMsg';
const rowKey = 't_msg_id';
const DateFormat = 'YYYY-MM-DD';

@connect(({ base }) => ({ base }))
@Form.create()
@List.create()
export default class TMsgList extends Component {
  state = {
...
temp = {
    ...
    const columns = [
      {
       ...
       {  title: '',   dataIndex: 't_msg_id',     width: 150,     sorter: false,      },
 {  title: '',   dataIndex: 'fromuserid',     width: 150,     sorter: false,      },
 {  title: '',   dataIndex: 'fromuseridname',     width: 150,     sorter: false,      },
 {  title: '',   dataIndex: 'touserid',     width: 150,     sorter: false,      },
 {  title: '',   dataIndex: 'touseridname',     width: 150,     sorter: false,      },
 {  title: '',   dataIndex: 'msgtext',     width: 150,     sorter: false,      },
 ...
 {  title: '创建时间',   dataIndex: 'create_date',     width: 150,     sorter: false,      },
    ...
    const listConfig = {
      url: '/api/TMsg/queryTMsgList', // 必填,请求url
        ...
        <Card bordered={false} style={{ marginBottom: 24 }} hoverable>
          <Form onSubmit={this.handleSearch}>
            <Row gutter={{ md: 8, lg: 24, xl: 48 }}>
              <Col {...formItemGrid}>  <FormItem {...formItemLayout} label=''>{getFieldDecorator('t_msg_id',{initialValue: this.props.list.queryMap.t_msg_id, })(<Input placeholder='请输入' />)} </FormItem> </Col>
...
<Col {...formItemGrid}>  <FormItem {...formItemLayout} label=''>{getFieldDecorator('fromuseridname',{initialValue: this.props.list.queryMap.fromuseridname, })(<Input placeholder='请输入' />)} </FormItem> </Col>
...
<Col {...formItemGrid}>  <FormItem {...formItemLayout} label=''>{getFieldDecorator('touseridname',{initialValue: this.props.list.queryMap.touseridname, })(<Input placeholder='请输入' />)} </FormItem> </Col>
<Col {...formItemGrid}>  <FormItem {...formItemLayout} label=''>{getFieldDecorator('msgtext',{initialValue: this.props.list.queryMap.msgtext, })(<Input placeholder='请输入' />)} </FormItem> </Col>

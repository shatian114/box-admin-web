          ...
          <Form onSubmit={this.handleSearch}>
            <Row gutter={{md: 8, lg: 24, xl: 48}}>
              <Col {...formItemGrid}> <FormItem {...formItemLayout}
                                                label='物业ID'>{getFieldDecorator('t_1wuyewuye_id', {initialValue: this.props.list.queryMap.t_1wuyewuye_id,})(
                <Input placeholder='请输入'/>)} </FormItem> </Col>
              <Col {...formItemGrid}> <FormItem {...formItemLayout}
                                                label='物业编号'>{getFieldDecorator('wybh', {initialValue: this.props.list.queryMap.wybh,})(
                <Input placeholder='请输入'/>)} </FormItem> </Col>
              <Col {...formItemGrid}> <FormItem {...formItemLayout}
                                                label='物业名称'>{getFieldDecorator('wymc', {initialValue: this.props.list.queryMap.wymc,})(
                <Input placeholder='请输入'/>)} </FormItem> </Col>
              <Col {...formItemGrid}> <FormItem {...formItemLayout}
                                                label='物业描述'>{getFieldDecorator('wyms', {initialValue: this.props.list.queryMap.wyms,})(
                <TextArea autosize={webConfig.textAreaAutoSize} placeholder='请输入'/>)} </FormItem> </Col>
              <Col {...formItemGrid}> <FormItem {...formItemLayout}

...
const routerUrl ='/TRedmoneyrecord';
        ...
        <Card bordered={false} style={{ marginBottom: 24 }} hoverable>
          <Form onSubmit={this.handleSearch}>
            <Row gutter={{ md: 8, lg: 24, xl: 48 }}>
              <Col {...formItemGrid}>  <FormItem {...formItemLayout} label=''>{getFieldDecorator('t_redmoneyrecord_id',{initialValue: this.props.list.queryMap.t_redmoneyrecord_id, })(<Input placeholder='请输入' />)} </FormItem> </Col>

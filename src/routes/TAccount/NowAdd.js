...
@Form.create()
export default class NowAdd extends React.PureComponent {
  state = {
    visible: false,
    info: {},
  };
        ...
        <Form onSubmit={this.handleSubmit}>
          ...
          <FormItem {...formItemLayout} label="当前余额">
            {getFieldDecorator('old_now_money', {
              initialValue: this.state.info.nowMoney || 0,
              rules: [
                {
                  required: true,
                  message: '当前余额不能缺失!',
          ...
          <FormItem {...formItemLayout} label="增加余额">

...
const { Option } = Select;
//const routerUrl = cache.keysMenu.TBbsBak4;
const routerUrl ='/TBbsBak4';
const url = 'TBbsBak4';
const rowKey = 't_bbs_bak4_id';
const DateFormat = 'YYYY-MM-DD';

@connect(({ base }) => ({ base }))
@Form.create()
@List.create()
export default class TBbsBak4List extends Component {
  state = {
...
temp = {
    ...
    const columns = [
      {
       ...
       {  title: '',   dataIndex: 't_bbs_bak4_id',     width: 150,     sorter: false,      },
 ...
 {  title: '创建时间',   dataIndex: 'create_date',     width: 150,     sorter: false,      },
    ...
    const listConfig = {
      url: '/api/TBbsBak4/queryTBbsBak4List', // 必填,请求url
        ...
        <Card bordered={false} style={{ marginBottom: 24 }} hoverable>
          <Form onSubmit={this.handleSearch}>
            <Row gutter={{ md: 8, lg: 24, xl: 48 }}>
              <Col {...formItemGrid}>  <FormItem {...formItemLayout} label=''>{getFieldDecorator('t_bbs_bak4_id',{initialValue: this.props.list.queryMap.t_bbs_bak4_id, })(<Input placeholder='请输入' />)} </FormItem> </Col>

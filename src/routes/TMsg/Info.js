...
{getFieldDecorator('tMsgId', {
 initialValue: info.tMsgId || newInfo.tMsgId,
  rules: [
    {
      required: true,
      message: '不能缺失!',
...
{getFieldDecorator('fromuserid', {
 ...
 <FormItem {...formItemLayout} hasFeedback label="">
{getFieldDecorator('fromuseridname', {
 initialValue: info.fromuseridname ||  newInfo.fromuseridname,
  rules: [
    {
      required: true,
      message: '不能缺失!',
...
{getFieldDecorator('touserid', {
 ...
 <FormItem {...formItemLayout} hasFeedback label="">
{getFieldDecorator('touseridname', {
 initialValue: info.touseridname ||  newInfo.touseridname,
  rules: [
    {
      required: true,
      message: '不能缺失!',
...
{getFieldDecorator('msgtext', {
 initialValue: info.msgtext ||  newInfo.msgtext,
  rules: [
    {
      required: true,
      message: '不能缺失!',
    },{ max: 1000,message: '必须小于1000位!',   },
  ],
 })(<Input placeholder="请输入" />)}
 </FormItem>
 <FormItem {...formItemLayout} hasFeedback label="">

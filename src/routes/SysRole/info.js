        ...
        <Form onSubmit={this.handleSubmit}>
          ...
          <FormItem {...formItemLayout} hasFeedback label="角色描述">
            {getFieldDecorator('roleDesc', {
              initialValue: info.roleDesc || newInfo.roleDesc,
              rules: [
                {
                  required: true,
                  message: '角色描述不能缺失!',
                },
                { max: 255, message: '角色描述必须小于255位!' },
              ],
            })(<Input placeholder="请输入" />)}
          </FormItem>
          <FormItem {...formItemLayout} hasFeedback label="角色名称">
            {getFieldDecorator('roleName', {
              initialValue: info.roleName || newInfo.roleName,
              rules: [
                {
                  required: true,
                  message: '角色名称不能缺失!',
                },
                { max: 255, message: '角色名称必须小于255位!' },
              ],
            })(<Input placeholder="请输入" />)}
          </FormItem>

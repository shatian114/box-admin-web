...
@Form.create()
@List.create()
export default class SysRole2menuList extends Component {
  state = {
  ...
  render() {
    ...
    const columns = [
      ...
      { title: '菜单id', dataIndex: 'menu_id', width: 150, sorter: false },
    ];

    const listConfig = {
      url: '/api/SysRole2menu/querySysRole2menuList', // 必填,请求url

 ...
 * @Last Modified time: 2018-06-07 09:35:52
 * @Description:条码
 */
...
const { Option } = Select;
const url = 'wmscoderecordNH';
const routerUrl = '/wmscoderecordNH';
...
@Form.create()
@List.create()
export default class WmsCoderecordNHList extends Component {
  state = {
  ...
  render() {
    ...
    const listConfig = {
      url: '/api/query/queryWmsCoderecordNHList', // 必填,请求url

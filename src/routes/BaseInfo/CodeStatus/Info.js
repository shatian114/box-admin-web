 ...
 * @Last Modified time: 2018-05-23 21:06:05
 * @Description: 字典详情
 */
    ...
    return (
      <Spin size="large" spinning={loading}>
        <Form onSubmit={this.handleSubmit}>
          <FormItem {...formItemLayout} hasFeedback label="载具状态编号">
            {getFieldDecorator('dicCode', {
              ...
              rules: [
                ...
                {
                  max: 64,
                  message: '载具状态编号必须小于64位!',
                },
              ],
            })(<Input disabled={info.dicId !== undefined} placeholder="请输入载具状态编号" />)}
          </FormItem>
          <FormItem {...formItemLayout} hasFeedback label="载具状态名称">
            {getFieldDecorator('dicName', {
              ...
              rules: [
                ...
                {
                  max: 64,
                  message: '载具状态名称必须小于64位!',
                },
              ],
            })(<Input placeholder="请输入载具状态名称" />)}
          </FormItem>

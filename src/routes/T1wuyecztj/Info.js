...
{getFieldDecorator('t1wuyecztjId', {
 initialValue: info.t1wuyecztjId || newInfo.t1wuyecztjId,
  rules: [
    {
      required: true,
      message: '不能缺失!',
...
{getFieldDecorator('zhs', {
 ...
 <FormItem {...formItemLayout} hasFeedback label="">
{getFieldDecorator('czze', {
 initialValue: info.czze ||  newInfo.czze,
  rules: [
    {
      required: true,
      message: '不能缺失!',
 ...
 <FormItem {...formItemLayout} hasFeedback label="">
{getFieldDecorator('czcs', {
 initialValue: info.czcs ||  newInfo.czcs,
  rules: [
    {
      required: true,
      message: '不能缺失!',

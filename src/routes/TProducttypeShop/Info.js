...
{getFieldDecorator('tProducttypeShopId', {
 initialValue: info.tProducttypeShopId || newInfo.tProducttypeShopId,
  rules: [
    {
      required: true,
      message: '不能缺失!',
...
{getFieldDecorator('producttypename', {
 initialValue: info.producttypename ||  newInfo.producttypename,
  rules: [
    {
      required: true,
      message: '产品类型名称不能缺失!',
    },{ max: 255,message: '产品类型名称必须小于255位!',   },
  ],

...
const { Option } = Select;
//const routerUrl = cache.keysMenu.TVirtualtype;
const routerUrl ='/TVirtualtype';
const url = 'TVirtualtype';
const rowKey = 't_virtualtype_id';
const DateFormat = 'YYYY-MM-DD';

@connect(({ base }) => ({ base }))
@Form.create()
@List.create()
export default class TVirtualtypeList extends Component {
  state = {
...
temp = {
 ...
 {  title: '创建时间',   dataIndex: 'create_date',     width: 150,     sorter: false,      },
    ...
    const listConfig = {
      url: '/api/TVirtualtype/queryTVirtualtypeList', // 必填,请求url

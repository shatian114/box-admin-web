...
export default class TVersioninfoList extends Component {
  ...
  render() {
    ...
    const columns = [
      ...
      {
        title: '显示几个标签。--这是长度为5的字符串，比如11011',
        dataIndex: 'fivetab',
        width: 150,
        sorter: false,
      },
            ...
            <Row gutter={{ md: 8, lg: 24, xl: 48 }}>
              <Col {...formItemGrid}>
                ...
                <FormItem {...formItemLayout} label="">
                  {getFieldDecorator('t_versioninfo_id', {
                    initialValue: this.props.list.queryMap.t_versioninfo_id,
              ...
              <Col {...formItemGrid}>
                {' '}
                <FormItem {...formItemLayout} label="客户端描述">
                  {getFieldDecorator('strappdes', {
                    initialValue: this.props.list.queryMap.strappdes,
                  })(<Input placeholder="请输入" />)}{' '}
                </FormItem>{' '}
              </Col>
              <Col {...formItemGrid}>
                {' '}
                <FormItem {...formItemLayout} label="导航图片1">
                  {getFieldDecorator('strflash1', {
                    initialValue: this.props.list.queryMap.strflash1,
                  })(<Input placeholder="请输入" />)}{' '}
                </FormItem>{' '}
              </Col>
              <Col {...formItemGrid}>
                {' '}
                <FormItem {...formItemLayout} label="导航图片2">
                  {getFieldDecorator('strflash2', {
                    initialValue: this.props.list.queryMap.strflash2,
                  })(<Input placeholder="请输入" />)}{' '}
                </FormItem>{' '}
              </Col>
              <Col {...formItemGrid}>
                {' '}
                <FormItem {...formItemLayout} label="导航图片3">
                  {getFieldDecorator('strflash3', {
                    initialValue: this.props.list.queryMap.strflash3,
                  })(<Input placeholder="请输入" />)}{' '}
                </FormItem>{' '}
              </Col>
              <Col {...formItemGrid}>
                {' '}
                <FormItem {...formItemLayout} label="导航图片4">
                  {getFieldDecorator('strflash4', {
                    initialValue: this.props.list.queryMap.strflash4,
                  })(<Input placeholder="请输入" />)}{' '}
                </FormItem>{' '}
              </Col>
              <Col {...formItemGrid}>
                {' '}
                <FormItem {...formItemLayout} label="标签1">
                  {getFieldDecorator('tabtext1', {
                    initialValue: this.props.list.queryMap.tabtext1,
                  })(<Input placeholder="请输入" />)}{' '}
                </FormItem>{' '}
              </Col>
              <Col {...formItemGrid}>
                {' '}
                <FormItem {...formItemLayout} label="标签2">
                  {getFieldDecorator('tabtext2', {
                    initialValue: this.props.list.queryMap.tabtext2,
                  })(<Input placeholder="请输入" />)}{' '}
                </FormItem>{' '}
              </Col>
              <Col {...formItemGrid}>
                ...
                <FormItem {...formItemLayout} label="">
                  {getFieldDecorator('tabtext3', {
                    initialValue: this.props.list.queryMap.tabtext3,
                  })(<Input placeholder="请输入" />)}{' '}
                </FormItem>{' '}
              </Col>
              <Col {...formItemGrid}>
                {' '}
                <FormItem {...formItemLayout} label="标签3">
                  {getFieldDecorator('tabtext4', {
                    initialValue: this.props.list.queryMap.tabtext4,
                  })(<Input placeholder="请输入" />)}{' '}
                </FormItem>{' '}
              </Col>
              <Col {...formItemGrid}>
                {' '}
                <FormItem {...formItemLayout} label="标签4">
                  {getFieldDecorator('tabtext5', {
                    initialValue: this.props.list.queryMap.tabtext5,
                  })(<Input placeholder="请输入" />)}{' '}
                </FormItem>{' '}
              </Col>
              <Col {...formItemGrid}>
                ...
                <FormItem
                  {...formItemLayout}
                  label="显示几个标签。--这是长度为5的字符串，比如11011"
                >
                  {getFieldDecorator('fivetab', { initialValue: this.props.list.queryMap.fivetab })(
                    <Input placeholder="请输入" />
                  )}{' '}
                </FormItem>{' '}
              </Col>
              <Col {...formItemGrid}>
                {' '}
                <FormItem {...formItemLayout} label="免责协议链接">
                  {getFieldDecorator('xieyilink', {
                    initialValue: this.props.list.queryMap.xieyilink,
                  })(<Input placeholder="请输入" />)}{' '}
                </FormItem>{' '}
              </Col>
              <Col {...formItemGrid}>

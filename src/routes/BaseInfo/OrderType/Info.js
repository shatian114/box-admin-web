 ...
 * @Last Modified time: 2018-05-21 10:40:35
 * @Description: 字典详情
 */
    ...
    return (
      <Spin size="large" spinning={loading}>
        <Form onSubmit={this.handleSubmit}>
          <FormItem {...formItemLayout} hasFeedback label="单据类型编号">
            {getFieldDecorator('dicCode', {
              ...
              rules: [
                ...
                {
                  max: 64,
                  message: '单据类型编号必须小于64位!',
                },
              ],
            })(<Input disabled={info.dicId !== undefined} placeholder="请输入单据类型编号" />)}
          </FormItem>
          <FormItem {...formItemLayout} hasFeedback label="单据类型名称">
            {getFieldDecorator('dicName', {
              ...
              rules: [
                ...
                {
                  max: 64,
                  message: '单据类型名称必须小于64位!',
                },
              ],
            })(<Input placeholder="请输入单据类型名称" />)}
          </FormItem>
          <FormItem {...formItemLayout} hasFeedback label="单据类型缩写(两位且不能重复)">

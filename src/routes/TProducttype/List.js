...
const { Option } = Select;
const routerUrl = cache.keysMenu.TProducttype;
const url = 'TProducttype';
const rowKey = 't_producttype_id';
const DateFormat = 'YYYY-MM-DD';

@connect(({ base }) => ({ base }))
@Form.create()
@List.create()
export default class TProducttypeList extends Component {
  state = {
  ...
  render() {
    ...
    const listConfig = {
      url: '/api/TProducttype/queryTProducttypeList', // 必填,请求url
            ...
            <Row gutter={{ md: 8, lg: 24, xl: 48 }}>
              <Col {...formItemGrid}>
                ...
                <FormItem {...formItemLayout} label="">
                  {getFieldDecorator('t_producttype_id', {
                    initialValue: this.props.list.queryMap.t_producttype_id,

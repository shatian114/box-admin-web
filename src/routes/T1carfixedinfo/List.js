...
<Col {...formItemGrid}>  <FormItem {...formItemLayout} label='到期时间'>{getFieldDecorator('expiredate',{initialValue: this.props.list.queryMap.expiredate, })(<Input placeholder='请输入' />)} </FormItem> </Col>

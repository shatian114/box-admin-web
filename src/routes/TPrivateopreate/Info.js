...
{getFieldDecorator('tPrivateopreateId', {
 initialValue: info.tPrivateopreateId || newInfo.tPrivateopreateId,
  rules: [
    {
      required: true,
      message: '不能缺失!',
 ...
 <FormItem {...formItemLayout} hasFeedback label="个人合作者id：这个不用系统生成，手工设定，长度是6位数字">
{getFieldDecorator('uniqueID', {
 initialValue: info.uniqueID ||  newInfo.uniqueID,
  rules: [
    {
      required: true,
      message: '个人合作者id：这个不用系统生成，手工设定，长度是6位数字不能缺失!',
    },{ max: 255,message: '个人合作者id：这个不用系统生成，手工设定，长度是6位数字必须小于255位!',   },
  ],

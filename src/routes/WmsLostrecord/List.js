 ...
 * @Last Modified time: 2018-06-11 18:00:57
 * @Description:条码
 */
...
@Form.create()
@List.create()
export default class WmslostrecordList extends Component {
  state = {
  ...
  render() {
    ...
    const listConfig = {
      url: '/api/query/queryWmsLostrecordList', // 必填,请求url
        ...
        <Card bordered={false} style={{ marginBottom: 24 }} hoverable>
          <Form onSubmit={this.handleSearch} layout="inline">
            <Row gutter={{ md: 8, lg: 24, xl: 48 }}>
              ...
              <Col md={8} sm={24}>
                <FormItem label="责任人">
                  {getFieldDecorator('lost_user', {
                    initialValue: this.props.list.queryMap.lost_user,
                  })(<Input placeholder="请输入" />)}
                </FormItem>
              </Col>
              <Col md={8} sm={24}>

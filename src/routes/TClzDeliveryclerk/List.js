...
<Col {...formItemGrid}>  <FormItem {...formItemLayout} label='配送点编号'>{getFieldDecorator('assignfood_id',{initialValue: this.props.list.queryMap.assignfood_id, })(<Input placeholder='请输入' />)} </FormItem> </Col>

            ...
            <Row gutter={{ md: 8, lg: 24, xl: 48 }}>
              <Col {...formItemGrid}>
                ...
                <FormItem {...formItemLayout} label="">
                  {getFieldDecorator('t_redmoneychangerecord_id', {
                    initialValue: this.props.list.queryMap.t_redmoneychangerecord_id,
              ...
              <Col {...formItemGrid}>
                ...
                <FormItem {...formItemLayout} label="余额">
                  {getFieldDecorator('leftamount', {
                    initialValue: this.props.list.queryMap.leftamount,
                  })(<Input placeholder="请输入" />)}{' '}
                </FormItem>{' '}
              </Col>
              <Col {...formItemGrid}>

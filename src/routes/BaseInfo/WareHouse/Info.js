 ...
 * @Last Modified time: 2018-05-17 11:56:45
 * @Description: 字典详情
 */
      ...
      <Spin size="large" spinning={loading}>
        <Form onSubmit={this.handleSubmit}>
          <FormItem {...formItemLayout} hasFeedback label="总库编号">
            ...
            })(<Input disabled={info.dicId !== undefined} placeholder="请输入总库编号" />)}
          </FormItem>
          <FormItem {...formItemLayout} hasFeedback label="总库名称">

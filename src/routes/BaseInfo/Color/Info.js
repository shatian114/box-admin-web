 ...
 * @Last Modified time: 2018-05-17 22:36:10
 * @Description: 字典详情
 */
    ...
    return (
      <Spin size="large" spinning={loading}>
        <Form onSubmit={this.handleSubmit}>
          <FormItem {...formItemLayout} hasFeedback label="颜色编号">
            ...
            })(<Input disabled={info.dicId !== undefined} placeholder="请输入颜色编号" />)}
          </FormItem>
          <FormItem {...formItemLayout} hasFeedback label="颜色名称">
          ...
          <FormItem {...formItemLayout} hasFeedback label="颜色缩写(一位且不能重复)">

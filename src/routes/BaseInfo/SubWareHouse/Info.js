 ...
 * @Last Modified time: 2018-06-11 17:50:53
 * @Description: 字典详情
 */
...
export default class MyInfo extends Component {
  ...
  render() {
    ...
    const { info, WareHouseType, WareHouse } = base;
    return (
      <Spin size="large" spinning={loading}>
        <Form onSubmit={this.handleSubmit}>
          <FormItem {...formItemLayout} hasFeedback label="子库编号">
            ...
            })(<Input disabled={info.dicId !== undefined} placeholder="请输入子库编号" />)}
          </FormItem>
          ...
          <FormItem {...formItemLayout} hasFeedback label="总库编号">
          ...
          <FormItem {...formItemLayout} hasFeedback label="子库类别">

...
const { Option } = Select;
//const routerUrl = cache.keysMenu.TProducttypeShop;
const routerUrl ='/TProducttypeShop';
const url = 'TProducttypeShop';
const rowKey = 't_producttype_shop_id';
const DateFormat = 'YYYY-MM-DD';

@connect(({ base }) => ({ base }))
@Form.create()
@List.create()
export default class TProducttypeShopList extends Component {
  state = {
...
temp = {
  ...
  handleExport = e => {
    ...
    dispatch({
        ...
        payload: {
        filename: 't_producttype_shop.xls',
    ...
    const columns = [
      {
       ...
       {  title: '',   dataIndex: 't_producttype_shop_id',     width: 150,     sorter: false,      },
 ...
 {  title: '创建时间',   dataIndex: 'create_date',     width: 150,     sorter: false,      },
    ...
    const listConfig = {
      url: '/api/TProducttypeShop/queryTProducttypeShopList', // 必填,请求url
        ...
        <Card bordered={false} style={{ marginBottom: 24 }} hoverable>
          <Form onSubmit={this.handleSearch}>
            <Row gutter={{ md: 8, lg: 24, xl: 48 }}>
              <Col {...formItemGrid}>  <FormItem {...formItemLayout} label=''>{getFieldDecorator('t_producttype_shop_id',{initialValue: this.props.list.queryMap.t_producttype_shop_id, })(<Input placeholder='请输入' />)} </FormItem> </Col>
